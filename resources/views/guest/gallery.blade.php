...
@section('card-title', 'Galeri Kegiatan')
@section('card-content')
    ...
    <div class="grid md:grid-cols-3 gap-4 mt-8">
        <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=800&q=80" alt="Workshop"
            class="rounded-xl h-56 w-full object-cover">
        <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&q=80" alt="Diskusi"
            class="rounded-xl h-56 w-full object-cover">
